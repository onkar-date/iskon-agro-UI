export const COMPANY_DATA = {
  ABOUT_US:
    'Established in the year 2015, IskonAgro® is engaged in the Import & Marketing of Speciality agro-inputs products. The Company is established by Mr. Samir Kumbhar (CEO and Managing Director), Agronomist by Profession.',
  VISION:
